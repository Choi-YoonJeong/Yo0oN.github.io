...
<center><img src="/images/posts/DataStructure/05.Tree/06.jpg" width="100%" /></center>
...
2. 방향 그래프<br>
  ...
  참고로 트리에서도 간선을 직선으로 표현하는데, 편의상 직선으로 한것일 뿐, 실제로는 부모에서 자식으로 이어지는 방향이 있기 때문에 방향 그래프에 속한다.<br>
